    ...
    <section id="about">
      <div class="container">
        <table class="table table-condensed table-bordered">
		     <thead>
              <tr>
                <th><center>Kode Unit</th>
                <th><center>Unit</th>
                <th><center>Jumlah Kuota</th>
            ...
            <tbody>
              <tr>
                ...
                <td> <center><?php print $m['kuota']; ?></center> </td>
                <td> <center></i></a>
                      <a href="editunit.php?ID=<?php print $m['id']?>" class="btn btn-warning btn-sm"><font size=2>Edit</a>
              </tr>
            </tbody>
            <?php
                }
