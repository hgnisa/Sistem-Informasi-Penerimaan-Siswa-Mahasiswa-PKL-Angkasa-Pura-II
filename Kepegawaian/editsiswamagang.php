        ...
        <div class="row">
            <div class="form col-md-6" >
			  <div class="about-content">
		        <h6><i><br><br><br><br><br><br><br>Edit data siswa magang:</i></h6>
		      </div>
                <form method="POST" action="Controller/editsiswamagang.php?ID=<?php print $ID;?>">
                ...
                <div class="form-group">
                  <input type ="email" class="form-control" name="Email" id="Email" placeholder="Masukkan Email Anda" value="<?php print $m->Email;?>"></input>
                  <div class="validation"></div>
                </div>
